    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-12 col-sm-6 col-lg-4">
                <div class="account-card account-card-primary text-white rounded p-3 mb-4 mb-lg-0">
                  ...
                  <p class="d-flex align-items-center m-0"> <span class="text-uppercase font-weight-500"><?php echo "$firstname $lastname"; ?></span> <img class="ml-auto" src="img/visa.png" alt="visa" title=""> </p>
              ...
              <div class="col-12 col-sm-6 col-lg-4 d-none">
                <div class="account-card text-white rounded p-3 mb-4 mb-lg-0">
                  ...
                  <p class="d-flex align-items-center m-0"> <span class="text-uppercase font-weight-500"><?php echo "$firstname $lastname"; ?></span> <img class="ml-auto" src="img/mastercard.png" alt="mastercard" title=""> </p>
                  <div class="account-card-overlay rounded"> <a href="#" data-target="#edit-card-details" data-toggle="modal" class="text-light btn-link mx-2"><span class="mr-1"><i class="fas fa-edit"></i></span>Edit</a> <a href="#" class="text-light btn-link mx-2"><span class="mr-1"><i class="fas fa-minus-circle"></i></span>Delete</a> </div>
                </div>
              </div>
                  ...
                  <form id="updateCard" method="post">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="input-group-prepend"> <span class="input-group-text"><img class="ml-auto" src="img/visa.png" alt="visa" title=""></span> </div>
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input id="editcvvNumber" type="password" class="form-control" data-bv-field="editcvvNumber" required="" value="321" placeholder="CVV (3 digits)"  autocomplete="off">
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="editcardHolderName">Card Holder Name</label>
                      <input type="text" class="form-control" data-bv-field="editcardHolderName" id="editcardHolderName" required="" value="<?php echo "$firstname $lastname"; ?>" placeholder="Card Holder Name"  autocomplete="off">
                    </div>
          ...
          ================================== -->
          <div id="add-new-card-details" class="modal fade" role="dialog" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body p-4">
                  <form id="addCard" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" data-bv-field="cardnumber" id="cardNumber" required="" value="" placeholder="Card Number" autocomplete="off">
                    </div>
                    <div class="form-row">
                      <div class="col-lg-6">
                        <div class="form-group">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input id="cvvNumber" type="password" class="form-control" data-bv-field="cvvnumber" required="" value="" placeholder="CVV (3 digits)"  autocomplete="off">
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="cardHolderName">Card Holder Name</label>
                      <input type="text" class="form-control" data-bv-field="cardholdername" id="cardHolderName" required="" value="" placeholder="Card Holder Name"  autocomplete="off">
                    </div>
          ...
          <!-- Bank Accounts
          ============================================= -->
          <div class="bg-light shadow-sm rounded p-4 mb-4 d-none">
                    ...
                    <div class="col-sm-7">
                      ...
                      <div class="px-3">
                        ...
                        <ul class="list-unstyled">
                          ...
                          <li class="text-muted"><?php echo "$firstname $lastname"; ?></li>
                        </ul>
                        <ul class="list-unstyled">
                ...
                <div class="modal-body p-4">
                  <form id="addbankaccount" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" data-bv-field="accountName" id="accountName" required="" value="" placeholder="e.g. <?php echo "$firstname $lastname"; ?>">
                    </div>
                    <div class="form-group">
