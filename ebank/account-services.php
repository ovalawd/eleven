...
<div class="row"> 
        ...
        <aside class="col-lg-3"> 
          <?php
            if (isset($_SESSION['user']['image']) && strlen($_SESSION['user']['image']) > 3 ) {
              ...
              $image =  HOST.'/img/proxy.duckduckgo.com.png';
            }
          ?>
          <!-- Profile Details
          =============================== -->
          <div class="bg-light shadow-sm rounded text-center p-3 mb-4">
            <div class="profile-thumb mt-3 mb-4"> 
              <img style="width: 80px;" class="rounded-circle" src="<?php echo $image; ?>" alt="">
              
            </div>
            <p class="text-3 font-weight-500 mb-2">Hello, <?php echo "$firstname $lastname"; ?></p>
          ...
          <div class="bg-light shadow-sm rounded text-center p-3 mb-4">
            ...
            <h3 class="text-9 font-weight-400">$<?php echo money_format('%i', $a_balance)?></h3>
        ...
        <div class="col-lg-9">
                    ...
                    <div class="row">
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" value="<?php echo "$firstname"; ?>" class="form-control" data-bv-field="firstName" id="firstName" required="" placeholder="First Name" >
                        </div>
                      </div>
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
                          <label for="fullName">Last Name</label>
                          <input type="text" value="<?php echo "$lastname"; ?>" class="form-control" data-bv-field="fullName" id="fullName" required="" placeholder="Full Name">
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-group">
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="text" value="-" class="form-control" data-bv-field="address" id="address" required="" placeholder="Address 1">
                        </div>
                      </div>
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
          ...
          ============================================= -->
          <div class="bg-light shadow-sm rounded p-4 mb-4">
            <h3 class="text-5 font-weight-400 mb-3">Account Settings</h3>
            <div class="row">
          ...
          ============================================= -->
          <div class="bg-light shadow-sm rounded p-4 mb-4">
            <h3 class="text-5 font-weight-400 mb-3">Email Addresses </h3>
            <div class="row">
          ...
          <div class="bg-light shadow-sm rounded p-4">
            <h3 class="text-5 font-weight-400 mb-3">Security </h3>
            <div class="row">
              <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">
                <label class="col-form-label">Password</label>
              </p>
              <p class="col-sm-9">
                <input type="password" class="form-control-plaintext" data-bv-field="password" id="password" value="EnterPassword" autocomplete="off">
              </p>
            </div>
          </div>
          <!-- Edit Details Modal
                ...
                <div class="modal-body p-4">
                  <form id="changePassword" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" data-bv-field="existingpassword" id="existingPassword" required="" placeholder="Enter Current Password" autocomplete="off">
                    </div>
                    <div class="form-group">
